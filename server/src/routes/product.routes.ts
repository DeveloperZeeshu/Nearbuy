...
import { addProduct, deactivateProduct, deleteProduct, getAllProducts, reactivateProduct, searchProducts, updateProduct } from "../controllers/product.controller.js";
