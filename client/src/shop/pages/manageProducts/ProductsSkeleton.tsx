        ...
        <div className="min-h-screen animate-pulse">
            ...
            <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <div className="h-4 w-62 lg:w-72 bg-slate-300 rounded"></div>
                </div>
            ...
            <div className="flex flex-col gap-2">
                {Array(6).fill(null).map((_, i) => (
                    <div
                        key={i}
                        className="bg-white rounded-lg shadow-sm p-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 lg:gap-15"
                    >
                        {/* PRODUCT INFO */}
