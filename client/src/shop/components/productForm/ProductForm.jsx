...
export const ProductForm = () => {
    const { closeProductForm, editingProduct } = useContext(AppContext)
  ...
  const submit = async (data) => {
    try {
      ...
      if (editingProduct) {
        ...
        res = await axios.put(
          `${import.meta.env.VITE_API_URL}/api/product/${editingProduct._id}`,
          payload,
          {
            headers: {
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex items-end">
                            ...
                            <Input
                                ...
                                disabled
                            />
                            <Button type="submit" text={editingProduct ? 'Edit' : 'Add'} />
                        </div>
                    </div>
                </form>
            </div>
